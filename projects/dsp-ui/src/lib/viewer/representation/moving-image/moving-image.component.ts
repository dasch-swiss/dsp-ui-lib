...
import { PointerValue } from '../av-helper/av-timeline/av-timeline.component';
import { AvInfo } from '../av-helper/av-models/av-info';
import { TooltipPosition } from '@angular/material/tooltip';

export interface MovingImageInfo {
    'name': string;
    'duration': number;
    'description'?: string;
}
...
export class MovingImageComponent implements OnInit {
    ...
    // matTooltipPosition
    matTooltipPos: TooltipPosition = 'above';
