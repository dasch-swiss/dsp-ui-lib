...
export class ResourceClass {
     ...
     * @param guiOrder the resource class's gui-order properties.
     */
    constructor(
        readonly id: string,
...
export class Property {
     ...
     * @param guiAttribute the gui attribute assigned to this property, if any.
     */
    constructor(
        readonly id: string,
...
class OntologyCache {
    ...
    /**
     * @param ontologies An array of all existing ontologies.
     */
    ontologies: Array<OntologyMetadata>;

    /**
     * @param resourceClassIrisForOntology list of all resource class Iris for a named graph.
     */
    resourceClassIrisForOntology: ResourceClassIrisForOntology;

    /**
     * @param resourceClasses resource class definitions.
     */
...
export class OntologyInformation {
     ...
     *
     * @param ontologyInfo the given definitions that have to be integrated.
     * @returns void
     */
     ...
     *
     * @param sortAsc sort resource classes by label in ascending order by default
     ...
     *
     * @param sortAsc sort properties by label in ascending order by default
...
export class OntologyCacheService {
     ...
     * @param excludedOntologies array of ontologies that should be excluded
     */
    private excludedOntologies: Array<string> = [Constants.SalsahGui, Constants.StandoffOntology];

    /**
     * @param excludedProperties properties that Knora is not responsible for and that have to be ignored because they cannot be resolved at the moment.
     */
    private excludedProperties: Array<string> = [Constants.Label];

    /**
     * @param nonResourceClasses class definitions that are not be treated as Knora resource classes
     */
    private nonResourceClasses: Array<string> = [Constants.ForbiddenResource, Constants.XMLToStandoffMapping, Constants.ListNode];

    /**
     * @param cacheOntology central instance that caches all definitions
     */
     ...
     *
     * @param ontologies metadata of all existing ontologies as JSON-LD.
     ...
     *
     * @param ontology the ontology to be cached.
     * @returns void
     */
     ...
     * If the definitions are not already in the cache, the will be retrieved from Knora and cached.
     *
     * @param propertyIris the Iris of the properties to be returned .
