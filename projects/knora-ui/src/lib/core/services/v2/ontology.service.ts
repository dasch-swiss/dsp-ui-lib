...
export class OntologyService extends ApiService {
     ...
     *
     * @param projectIri iri of a specific project
     ...
     * Create new ontology.
     *
     * @param data Data contains: projectIri, name, label
     ...
     * @param classIri resource iri
     * @param propertyIri property iri
     * @param cardinality cardinality
     * @param guiOrder order number to display properties
     *
     * @returns Observable
     */
     ...
     *
     * @param sl array of string literal
